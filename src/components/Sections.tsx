...
export function HowItWorks() {
 ...
 <section className="pt-40 pb-32 px-6 max-w-7xl mx-auto overflow-visible relative"id="how-it-works">
  ...
  <p className="text-lg text-muted-foreground font-medium">Four simple steps to create an unforgettable moment.</p>
  </div>
  ...
  >
   <p className="text-[11px] font-bold text-muted-foreground/30 uppercase tracking-tight">Ready to start the journey?</p>
  </motion.div>
  </div>
 </section>
 );
...
export function DemoVideos() {
 ...
 <section className="py-40 max-w-[100vw] relative bg-background overflow-visible"id="demos">
  ...
  >
   ...
   >
    ...
    <div className="space-y-4">
     ...
     <span className="font-bold text-2xl leading-none mb-1.5">{demo.title}</span>
  ...
  <div className="max-w-7xl mx-auto px-6 mt-16 flex items-center gap-6">
   ...
   <span className="text-[11px] font-bold text-muted-foreground/40 uppercase tracking-wider">Scroll to see magic in action</span>
  </div>
 </section>
 );
}
